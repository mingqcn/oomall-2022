...
import cn.edu.xmu.oomall.payment.mapper.generator.po.LedgerPoExample.Criteria;
import cn.edu.xmu.oomall.payment.mapper.generator.po.LedgerPoExample.Criterion;
import cn.edu.xmu.oomall.payment.mapper.generator.po.LedgerPoExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class LedgerPoSqlProvider {
    /**
     ...
     * @mbg.generated
     */
    public String insertSelective(LedgerPo row) {
        SQL sql = new SQL();
        sql.INSERT_INTO("payment_ledger");
        ...
        if (row.getTransId() != null) {
            sql.VALUES("`trans_id`", "#{transId,jdbcType=BIGINT}");
        }
        
        if (row.getCheckTime() != null) {
     ...
     * @mbg.generated
     */
    public String selectByExample(LedgerPoExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        LedgerPo row = (LedgerPo) parameter.get("row");
        LedgerPoExample example = (LedgerPoExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("payment_ledger");
        ...
        if (row.getTransId() != null) {
            sql.SET("`trans_id` = #{row.transId,jdbcType=BIGINT}");
        }
        
        if (row.getCheckTime() != null) {
            sql.SET("`check_time` = #{row.checkTime,jdbcType=TIMESTAMP}");
        }
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(LedgerPo row) {
        SQL sql = new SQL();
        sql.UPDATE("payment_ledger");
        ...
        if (row.getTransId() != null) {
            sql.SET("`trans_id` = #{transId,jdbcType=BIGINT}");
        }
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, LedgerPoExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
