...
import cn.edu.xmu.oomall.payment.mapper.generator.po.DivRefundTransPoExample.Criteria;
import cn.edu.xmu.oomall.payment.mapper.generator.po.DivRefundTransPoExample.Criterion;
...
public class DivRefundTransPoSqlProvider {
    ...
    public String insertSelective(DivRefundTransPo row) {
        SQL sql = new SQL();
        sql.INSERT_INTO("payment_div_refund_trans");
        ...
        if (row.getRefundTransId() != null) {
            sql.VALUES("`refund_trans_id`", "#{refundTransId,jdbcType=BIGINT}");
        }
        
        if (row.getDivPayTransId() != null) {
            sql.VALUES("`div_pay_trans_id`", "#{divPayTransId,jdbcType=BIGINT}");
        }
    ...
    public String selectByExample(DivRefundTransPoExample example) {
        ...
        sql.SELECT("`refund_trans_id`");
        sql.SELECT("`div_pay_trans_id`");
        ...
        sql.SELECT("`status`");
        sql.FROM("payment_div_refund_trans");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        SQL sql = new SQL();
        sql.UPDATE("payment_div_refund_trans");
        ...
        if (row.getRefundTransId() != null) {
            sql.SET("`refund_trans_id` = #{row.refundTransId,jdbcType=BIGINT}");
        }
        
        if (row.getDivPayTransId() != null) {
            sql.SET("`div_pay_trans_id` = #{row.divPayTransId,jdbcType=BIGINT}");
        }
    ...
    public String updateByPrimaryKeySelective(DivRefundTransPo row) {
        ...
        if (row.getRefundTransId() != null) {
            sql.SET("`refund_trans_id` = #{refundTransId,jdbcType=BIGINT}");
        }
        
        if (row.getDivPayTransId() != null) {
            sql.SET("`div_pay_trans_id` = #{divPayTransId,jdbcType=BIGINT}");
        }
