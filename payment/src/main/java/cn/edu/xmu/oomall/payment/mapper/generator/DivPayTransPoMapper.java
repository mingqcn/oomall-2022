...
public interface DivPayTransPoMapper {
     ...
     */
    @Delete({
        "delete from payment_div_pay_trans",
     ...
     */
    @Insert({
        "insert into payment_div_pay_trans (`out_no`, `trans_no`, ",
        "`amount`, `success_time`, ",
        "`adjust_id`, `adjust_name`, ",
        "`adjust_time`, `pay_trans_id`, ",
        "`creator_id`, `creator_name`, ",
        "`modifier_id`, `modifier_name`, ",
        "`gmt_create`, `gmt_modified`, ",
        "`shop_channel_id`, `status`)",
        "values (#{outNo,jdbcType=VARCHAR}, #{transNo,jdbcType=VARCHAR}, ",
        "#{amount,jdbcType=BIGINT}, #{successTime,jdbcType=TIMESTAMP}, ",
        "#{adjustId,jdbcType=BIGINT}, #{adjustName,jdbcType=VARCHAR}, ",
        "#{adjustTime,jdbcType=TIMESTAMP}, #{payTransId,jdbcType=BIGINT}, ",
        ...
        "#{shopChannelId,jdbcType=BIGINT}, #{status,jdbcType=INTEGER})"
    })
    ...
    @Select({
        "select",
        "`id`, `out_no`, `trans_no`, `amount`, `success_time`, `adjust_id`, `adjust_name`, ",
        "`adjust_time`, `pay_trans_id`, `creator_id`, `creator_name`, `modifier_id`, ",
        "`modifier_name`, `gmt_create`, `gmt_modified`, `shop_channel_id`, `status`",
        "from payment_div_pay_trans",
        "where `id` = #{id,jdbcType=BIGINT}"
    })
    @Results({
        @Result(column="id", property="id", jdbcType=JdbcType.BIGINT, id=true),
